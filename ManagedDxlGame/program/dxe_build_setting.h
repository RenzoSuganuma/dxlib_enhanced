...
// ウィンドウの幅
const int DXE_WINDOW_WIDTH = 1920;
...
// ウィンドウの高さ
const int DXE_WINDOW_HEIGHT = 1080;
...
// ウィンドウモード
const bool DXE_WINDOW_MODE = false;

// マウスカーソルを表示するか
const bool DXE_MOUSE_VISIBLE = false;
...
const bool DXE_ALLWAYS_RUN_FLAG = false ;
